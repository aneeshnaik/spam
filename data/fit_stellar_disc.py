...
Author: A. P. Naik
Description: Code to fit galactic disc component for SPARC galaxies.
"""
...
sparc = SPARCGlobal()
file = open("SPARCData/stellar_disc_parameters.txt", 'w')
...
for galaxy in sparc.galaxies:
    ...
    file.write(galaxy.name+'\t'+str(popt[0])+'\t'+str(popt[1])+'\n')
